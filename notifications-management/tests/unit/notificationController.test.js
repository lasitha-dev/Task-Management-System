...
describe('NotificationController', () => {
    ...
    describe('createNotification', () => {
        it('should return 201 when notification is created', async () => {
            ...
            const req = { body: { type: 'task_assigned', title: 'New', message: 'Msg', recipientId: 'u1' } };
            const res = mockRes();
    ...
    describe('markAllAsRead', () => {
        it('should return 200 with modified count', async () => {
            ...
            const req = { body: { recipientId: 'user_001' } };
            const res = mockRes();
    ...
    describe('getUnreadCount', () => {
        it('should return 200 with unread count', async () => {
            ...
            const req = { query: { recipientId: 'user_001' } };
            const res = mockRes();
    ...
    describe('updatePreferences', () => {
        it('should return 200 with updated preferences', async () => {
            ...
            const req = { params: { userId: 'u1' }, body: { emailEnabled: false } };
            const res = mockRes();
